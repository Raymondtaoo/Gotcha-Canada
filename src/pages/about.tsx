        ...
        >
          <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="container mx-auto bg-white bg-opacity-90 p-6 rounded-lg shadow-lg">
              ...
              <p className="text-xl">
                Gotcha Bubble Tea began its journey with a vision to redefine
                &rsquo;tea time&rsquo; for tea enthusiasts. As the first luxury
                bubble tea dispensary in Canada, we&rsquo;ve become an
            ...
            <div className="container mx-auto bg-white bg-opacity-90 p-6 rounded-lg shadow-lg">
              ...
              <p className="text-xl">
                ...
                farms in Taiwan, ensuring each cup is not only delicious but
                also organically and sustainably produced. Our natural syrups
                and unique recipes set us apart as the purveyors of the finest
                teas available.
              </p>
            </div>
            <div className="container mx-auto bg-white bg-opacity-90 p-6 rounded-lg shadow-lg">
